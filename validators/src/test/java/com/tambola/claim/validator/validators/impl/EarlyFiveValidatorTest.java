...
public class EarlyFiveValidatorTest {
    ...
    public void testEarlyFiveClaimAccepted() {
        ...
        Assertions.assertEquals(ClaimStatus.ACCEPTED, tambolaHandler.validateClaim(ClaimType.EARLY_FIVE, announcedNumbers));
    }

    @Test
    public void testEarlyFiveClaimRejectedDueToLateClaim() {
        List<Integer> announcedNumbers = Arrays.asList(4, 16, 48, 63, 76, 12);
        Assertions.assertEquals(ClaimStatus.REJECTED, tambolaHandler.validateClaim(ClaimType.EARLY_FIVE, announcedNumbers));
    }
}
